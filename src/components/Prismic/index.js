...
const options = Object.assign({}, PrismicConfig.accessToken ? {accessToken: PrismicConfig.accessToken} : {})
export const Client = PrismicLib.client(PrismicConfig.endpoint, options)

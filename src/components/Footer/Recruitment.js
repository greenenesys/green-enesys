...
const Footer = ( ) => {
    return (
        <Wrapper>
            <H2 align={'center'} strip>Your next job is here.</H2>
            <Plant src={illustration}/>
            <ParagraphWrapper>
                <Paragraph strip lineHeight={'xs'} align={'center'}> Green Enesys is constantly looking for talanted people to join our team! </Paragraph>
            </ParagraphWrapper>
